...
table.insert(data.raw["technology"]["repair-tech"].effects,{type="unlock-recipe",recipe="basic-constructor"})
table.insert(data.raw["technology"]["repair-tech"].effects,{type="unlock-recipe",recipe="construction-warehouse"})
