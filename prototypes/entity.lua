...
local basic_constructor = {
  ...
  attack_parameters =
  {
    ...
    min_range = 0,
    sound = make_heavy_shot_sounds(1.0),
    animation = robotAnimation("droid_repair_run", {r=1, g=1, b=1, a=1}, 1),
    ammo_type =
    {
      category = "bullet",
      action =
  ...
  idle = robotAnimation("droid_repair_run", {r=1, g=1, b=1, a=1}, 1),
  run_animation = robotAnimation("droid_repair_run", {r=1, g=1, b=1, a=1}, 1),
}
